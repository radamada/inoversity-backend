...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Ion Popescu' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'ion@example.com' }),
    (0, class_validator_1.IsEmail)({}, { message: 'Email invalid' }),
    __metadata("design:type", String)
], ContactDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Întrebare despre un curs' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Bună ziua, am o întrebare...' }),
    (0, class_validator_1.IsString)(),
