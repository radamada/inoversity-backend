...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listare cursuri publicate' }),
...
__decorate([
    (0, common_1.Get)(':slug'),
    (0, swagger_1.ApiOperation)({ summary: 'Detalii curs după slug' }),
...
__decorate([
    (0, common_1.Get)(':id/curriculum'),
    (0, swagger_1.ApiOperation)({ summary: 'Curriculum curs (secțiuni + lecții)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CoursesController.prototype, "getCurriculum", null);
__decorate([
    (0, common_1.Post)(),
